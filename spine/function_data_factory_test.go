...
func TestFunctionDataFactory_FunctionData(t *testing.T) {
	result := CreateFunctionData[api.FunctionData](model.FeatureTypeTypeBill)
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeDeviceClassification)
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeDeviceConfiguration)
	assert.Equal(t, 3, len(result))
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeDeviceDiagnosis)
	assert.Equal(t, 3, len(result))
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeElectricalConnection)
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeHvac)
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeIdentification)
	assert.Equal(t, 3, len(result))
	assert.IsType(t, &FunctionDataImpl[model.IdentificationListDataType]{}, result[0])

	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeIncentiveTable)
	assert.Equal(t, 3, len(result))
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeLoadControl)
	assert.Equal(t, 6, len(result))
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeMeasurement)
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeTimeSeries)
	assert.Equal(t, 3, len(result))
	...
	result = CreateFunctionData[api.FunctionData](model.FeatureTypeTypeGeneric)
	assert.Equal(t, 124, len(result))
}

func TestFunctionDataFactory_FunctionDataCmd(t *testing.T) {
	result := CreateFunctionData[api.FunctionDataCmd](model.FeatureTypeTypeDeviceClassification)
	assert.Equal(t, 2, len(result))
...
func TestFunctionDataFactory_NodeMgmtFeatureType(t *testing.T) {
	result := CreateFunctionData[api.FunctionDataCmd](model.FeatureTypeTypeNodeManagement)
	assert.Equal(t, 3, len(result))
}
