...
func (_m *FeatureRemoteInterface) DataCopy(function model.FunctionType) any {
...
func (_c *FeatureRemoteInterface_DataCopy_Call) Return(_a0 any) *FeatureRemoteInterface_DataCopy_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *FeatureRemoteInterface_DataCopy_Call) RunAndReturn(run func(model.FunctionType) any) *FeatureRemoteInterface_DataCopy_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateData provides a mock function with given fields: persist, function, data, filterPartial, filterDelete
func (_m *FeatureRemoteInterface) UpdateData(persist bool, function model.FunctionType, data any, filterPartial *model.FilterType, filterDelete *model.FilterType) (any, *model.ErrorType) {
	ret := _m.Called(persist, function, data, filterPartial, filterDelete)
	...
	if rf, ok := ret.Get(0).(func(bool, model.FunctionType, any, *model.FilterType, *model.FilterType) (any, *model.ErrorType)); ok {
		return rf(persist, function, data, filterPartial, filterDelete)
	}
	if rf, ok := ret.Get(0).(func(bool, model.FunctionType, any, *model.FilterType, *model.FilterType) any); ok {
		r0 = rf(persist, function, data, filterPartial, filterDelete)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(any)
		}
	...
	if rf, ok := ret.Get(1).(func(bool, model.FunctionType, any, *model.FilterType, *model.FilterType) *model.ErrorType); ok {
		r1 = rf(persist, function, data, filterPartial, filterDelete)
	} else {
		if ret.Get(1) != nil {
...
func (_c *FeatureRemoteInterface_UpdateData_Call) Run(run func(persist bool, function model.FunctionType, data any, filterPartial *model.FilterType, filterDelete *model.FilterType)) *FeatureRemoteInterface_UpdateData_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bool), args[1].(model.FunctionType), args[2].(any), args[3].(*model.FilterType), args[4].(*model.FilterType))
	})
	return _c
}

func (_c *FeatureRemoteInterface_UpdateData_Call) Return(_a0 any, _a1 *model.ErrorType) *FeatureRemoteInterface_UpdateData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *FeatureRemoteInterface_UpdateData_Call) RunAndReturn(run func(bool, model.FunctionType, any, *model.FilterType, *model.FilterType) (any, *model.ErrorType)) *FeatureRemoteInterface_UpdateData_Call {
	_c.Call.Return(run)
	return _c
}
