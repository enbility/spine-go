...
func (_m *FunctionDataInterface) DataCopyAny() any {
	ret := _m.Called()
...
func (_c *FunctionDataInterface_DataCopyAny_Call) Return(_a0 any) *FunctionDataInterface_DataCopyAny_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *FunctionDataInterface) UpdateDataAny(remoteWrite bool, persist bool, data any, filterPartial *model.FilterType, filterDelete *model.FilterType) (any, *model.ErrorType) {
...
func (_c *FunctionDataInterface_UpdateDataAny_Call) Return(_a0 any, _a1 *model.ErrorType) *FunctionDataInterface_UpdateDataAny_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *FunctionDataInterface_UpdateDataAny_Call) RunAndReturn(run func(bool, bool, any, *model.FilterType, *model.FilterType) (any, *model.ErrorType)) *FunctionDataInterface_UpdateDataAny_Call {
	_c.Call.Return(run)
	return _c
}
