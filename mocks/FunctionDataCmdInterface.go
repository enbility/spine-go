...
func (_m *FunctionDataCmdInterface) DataCopyAny() any {
	ret := _m.Called()
...
func (_c *FunctionDataCmdInterface_DataCopyAny_Call) Return(_a0 any) *FunctionDataCmdInterface_DataCopyAny_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *FunctionDataCmdInterface) NotifyOrWriteCmdType(deleteSelector any, partialSelector any, partialWithoutSelector bool, deleteElements any) model.CmdType {
	...
	if rf, ok := ret.Get(0).(func(any, any, bool, any) model.CmdType); ok {
...
func (_c *FunctionDataCmdInterface_NotifyOrWriteCmdType_Call) Run(run func(deleteSelector any, partialSelector any, partialWithoutSelector bool, deleteElements any)) *FunctionDataCmdInterface_NotifyOrWriteCmdType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(any), args[1].(any), args[2].(bool), args[3].(any))
	})
	return _c
}
...
func (_c *FunctionDataCmdInterface_NotifyOrWriteCmdType_Call) RunAndReturn(run func(any, any, bool, any) model.CmdType) *FunctionDataCmdInterface_NotifyOrWriteCmdType_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FunctionDataCmdInterface) ReadCmdType(partialSelector any, elements any) model.CmdType {
	...
	var r0 model.CmdType
	if rf, ok := ret.Get(0).(func(any, any) model.CmdType); ok {
...
func (_c *FunctionDataCmdInterface_ReadCmdType_Call) RunAndReturn(run func(any, any) model.CmdType) *FunctionDataCmdInterface_ReadCmdType_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FunctionDataCmdInterface) UpdateDataAny(remoteWrite bool, persist bool, data any, filterPartial *model.FilterType, filterDelete *model.FilterType) (any, *model.ErrorType) {
	...
	if rf, ok := ret.Get(0).(func(bool, bool, any, *model.FilterType, *model.FilterType) (any, *model.ErrorType)); ok {
		return rf(remoteWrite, persist, data, filterPartial, filterDelete)
	}
	if rf, ok := ret.Get(0).(func(bool, bool, any, *model.FilterType, *model.FilterType) any); ok {
	...
	if rf, ok := ret.Get(1).(func(bool, bool, any, *model.FilterType, *model.FilterType) *model.ErrorType); ok {
...
func (_c *FunctionDataCmdInterface_UpdateDataAny_Call) Run(run func(remoteWrite bool, persist bool, data any, filterPartial *model.FilterType, filterDelete *model.FilterType)) *FunctionDataCmdInterface_UpdateDataAny_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bool), args[1].(bool), args[2].(any), args[3].(*model.FilterType), args[4].(*model.FilterType))
	})
	return _c
}

func (_c *FunctionDataCmdInterface_UpdateDataAny_Call) Return(_a0 any, _a1 *model.ErrorType) *FunctionDataCmdInterface_UpdateDataAny_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *FunctionDataCmdInterface_UpdateDataAny_Call) RunAndReturn(run func(bool, bool, any, *model.FilterType, *model.FilterType) (any, *model.ErrorType)) *FunctionDataCmdInterface_UpdateDataAny_Call {
	_c.Call.Return(run)
	return _c
}
