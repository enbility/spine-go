...
// AddEntityAndFeatures provides a mock function with given fields: initialData, data, entityAddressToAdd
func (_m *DeviceRemoteInterface) AddEntityAndFeatures(initialData bool, data *model.NodeManagementDetailedDiscoveryDataType, entityAddressToAdd *model.EntityAddressType) ([]api.EntityRemoteInterface, error) {
	ret := _m.Called(initialData, data, entityAddressToAdd)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(bool, *model.NodeManagementDetailedDiscoveryDataType, *model.EntityAddressType) ([]api.EntityRemoteInterface, error)); ok {
		return rf(initialData, data, entityAddressToAdd)
	}
	if rf, ok := ret.Get(0).(func(bool, *model.NodeManagementDetailedDiscoveryDataType, *model.EntityAddressType) []api.EntityRemoteInterface); ok {
		r0 = rf(initialData, data, entityAddressToAdd)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(bool, *model.NodeManagementDetailedDiscoveryDataType, *model.EntityAddressType) error); ok {
		r1 = rf(initialData, data, entityAddressToAdd)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *DeviceRemoteInterface_AddEntityAndFeatures_Call) Run(run func(initialData bool, data *model.NodeManagementDetailedDiscoveryDataType, entityAddressToAdd *model.EntityAddressType)) *DeviceRemoteInterface_AddEntityAndFeatures_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bool), args[1].(*model.NodeManagementDetailedDiscoveryDataType), args[2].(*model.EntityAddressType))
	})
	return _c
}
...
func (_c *DeviceRemoteInterface_AddEntityAndFeatures_Call) RunAndReturn(run func(bool, *model.NodeManagementDetailedDiscoveryDataType, *model.EntityAddressType) ([]api.EntityRemoteInterface, error)) *DeviceRemoteInterface_AddEntityAndFeatures_Call {
	_c.Call.Return(run)
	return _c
}
