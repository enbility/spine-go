...
func (_m *EntityLocalInterface) HasUseCaseSupport(_a0 model.UseCaseFilterType) bool {
	ret := _m.Called(_a0)
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(model.UseCaseFilterType) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
func (_c *EntityLocalInterface_HasUseCaseSupport_Call) Run(run func(_a0 model.UseCaseFilterType)) *EntityLocalInterface_HasUseCaseSupport_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(model.UseCaseFilterType))
	})
	return _c
}
...
func (_c *EntityLocalInterface_HasUseCaseSupport_Call) RunAndReturn(run func(model.UseCaseFilterType) bool) *EntityLocalInterface_HasUseCaseSupport_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EntityLocalInterface) RemoveUseCaseSupports(_a0 []model.UseCaseFilterType) {
	_m.Called(_a0)
}
...
func (_c *EntityLocalInterface_RemoveUseCaseSupports_Call) RunAndReturn(run func([]model.UseCaseFilterType)) *EntityLocalInterface_RemoveUseCaseSupports_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EntityLocalInterface) SetUseCaseAvailability(filter model.UseCaseFilterType, available bool) {
...
func (_c *EntityLocalInterface_SetUseCaseAvailability_Call) Run(run func(filter model.UseCaseFilterType, available bool)) *EntityLocalInterface_SetUseCaseAvailability_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(model.UseCaseFilterType), args[1].(bool))
	})
	return _c
}
