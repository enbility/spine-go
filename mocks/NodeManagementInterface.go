...
func (_m *NodeManagementInterface) AddResultCallback(msgCounterReference model.MsgCounterType, function func(api.ResultMessage)) {
...
func (_e *NodeManagementInterface_Expecter) AddResultCallback(msgCounterReference interface{}, function interface{}) *NodeManagementInterface_AddResultCallback_Call {
	return &NodeManagementInterface_AddResultCallback_Call{Call: _e.mock.On("AddResultCallback", msgCounterReference, function)}
}

func (_c *NodeManagementInterface_AddResultCallback_Call) Run(run func(msgCounterReference model.MsgCounterType, function func(api.ResultMessage))) *NodeManagementInterface_AddResultCallback_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *NodeManagementInterface_AddResultCallback_Call) RunAndReturn(run func(model.MsgCounterType, func(api.ResultMessage))) *NodeManagementInterface_AddResultCallback_Call {
	_c.Call.Return(run)
	return _c
}

// AddResultHandler provides a mock function with given fields: handler
func (_m *NodeManagementInterface) AddResultHandler(handler api.FeatureResultInterface) {
	_m.Called(handler)
}

// NodeManagementInterface_AddResultHandler_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddResultHandler'
type NodeManagementInterface_AddResultHandler_Call struct {
	*mock.Call
}

// AddResultHandler is a helper method to define mock.On call
//   - handler api.FeatureResultInterface
func (_e *NodeManagementInterface_Expecter) AddResultHandler(handler interface{}) *NodeManagementInterface_AddResultHandler_Call {
	return &NodeManagementInterface_AddResultHandler_Call{Call: _e.mock.On("AddResultHandler", handler)}
}

func (_c *NodeManagementInterface_AddResultHandler_Call) Run(run func(handler api.FeatureResultInterface)) *NodeManagementInterface_AddResultHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *NodeManagementInterface_AddResultHandler_Call) Return() *NodeManagementInterface_AddResultHandler_Call {
	_c.Call.Return()
	return _c
}

func (_c *NodeManagementInterface_AddResultHandler_Call) RunAndReturn(run func(api.FeatureResultInterface)) *NodeManagementInterface_AddResultHandler_Call {
	_c.Call.Return(run)
	return _c
}
